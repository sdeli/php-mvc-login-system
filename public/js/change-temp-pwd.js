(function () {
    ...
    function addCustomValidationMethod() {
        let erroMsg = 'Your New Passwrod is not enough secure! It must containt at least one Captial Letter, one Lowercase Letter, one Number and must be longer than 7 characters';  
